...
class MachineGroupStatus(BaseWidgetOutput):
    """Machine group status configuration (for newer models like Strada X)."""
...
class GrinderDoses(BaseWidgetOutput):
    ...
    scale_connected: bool | None = field(
        metadata=field_options(alias="scaleConnected"), default=False
    )
...
class GrinderSpeed(BaseWidgetOutput):
    """Grinder speed configuration (for Swan grinder)."""
...
class GrinderMoreDose(BaseWidgetOutput):
    """Grinder more dose configuration (for Swan grinder)."""
...
class GrinderGrindWith(BaseWidgetOutput):
    """Grinder grind mode configuration (for Swan grinder)."""
